...
def getDataLoaderAndLabels(batchSize:int = 8, tokenizer: AutoTokenizer = None):
    rawTexts,rawLabels = getNewTestDatas()
    ...
    input_ids,attention_mask = testInputs['input_ids'],testInputs['attention_mask']        
...
def getNewTestDatas():
    ...
    for idx,data in enumerate(datas):
        ...
        texts.append(splitData[0].strip())
        labels.append(splitData[1].strip())
    return texts,labels 
